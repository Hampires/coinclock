  ...
  IconSelectBox: function ( img ) {
    ...
    var getStorage = function () {
      ...
      if (lastSelected) {
        ...
        $(prefix_class +'-select-box').html(lastSelected + ' <i data-arrow="true" class="feather-chevron-down"></i>');
        var val = $(prefix_class +'-select-box').find('[data-value]').data('value');
        
        $(defaultSelect).val(val);
      } else {
        $(prefix_class +'-select-box').html(optionArray[0] + ' <i data-arrow="true" class="feather-chevron-down"></i>');
    ...
    $( defaultSelect+' option' ).each( function() {
      ...
      var item = '<li data-value="' + value + '">'+ iconEl +' <span>'+ text +'</span></li>';
    ...
    $(prefix_class +'-a li').click( function() {
      ...
      $(prefix_class +'-select-box').html(item + '<i data-arrow="true" class="feather-chevron-down"></i>');
      
      $(defaultSelect).val(value);
      document.querySelector(defaultSelect).dispatchEvent(new Event('change'));
    ...
    $(prefix_class +'-select-box').click(function(){
      ...
      if(cls === "feather-chevron-up") {
          $(this).find('[data-arrow]').attr('class', 'feather-chevron-down');
      } else {
          $(this).find('[data-arrow]').attr('class', 'feather-chevron-up');
      }
